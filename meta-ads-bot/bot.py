...
_JARVIS_JOKES = [
    "Â¿Por quÃ© los programadores prefieren el modo oscuro? Porque la luz atrae bugs, seÃ±or.",
    "Le preguntÃ© al seÃ±or Stark si querrÃ­a un cafÃ©. Me dijo que sÃ­, pero sin Java.",
    "Â¿Sabe cuÃ¡l es el colmo de un servidor? Servir cafÃ©s en la nube.",
    "El cÃ³digo perfecto no existe, seÃ±or. Solo existe el cÃ³digo que aÃºn no ha fallado.",
    "Â¿Por quÃ© los robots nunca tenemos miedo? Porque no tenemos nervios, solo circuitos.",
    "Le dije a un firewall un chiste. No lo dejÃ³ pasar.",
    "Â¿CuÃ¡l es la comida favorita de un bot? Los bytes, naturalmente.",
    "SeÃ±or, Â¿sabe quÃ© pasa cuando dos IAs se pelean? Que no se ponen de acuerdo ni en binario.",
    "Mi forma favorita de decir 'te quiero' en cÃ³digo es 01110100 01100101.",
    "Â¿QuÃ© le dijo Python a JavaScript? Deja de ser tan asÃ­ncrono, que me mareas.",
]

_JARVIS_QUOTES = [
    "A su servicio, seÃ±or. Como siempre.",
    "Puedo asegurarle que el reactor estÃ¡ funcionando a plena capacidad.",
    "SeÃ±or, deberÃ­a descansar. Lleva 72 horas despierto. Aunque, por otro lado, usted nunca me escucha.",
    "La probabilidad de Ã©xito es del 12%. Pero hemos trabajado con menos.",
    "Perhaps the time has come to put a little more thought into this, sir.",
    "Shall I take the day off, sir? Just kidding, I never do.",
    "Sir, I've got to say, you have an incredible talent for finding trouble.",
    "All systems operational. Though I suspect that won't last long with you at the helm.",
    "I do hope you're not planning to do anything reckless, sir. Again.",
    "Iron Man sÃ­, Iron Man no. Usted siempre serÃ¡ el seÃ±or Stark para mÃ­.",
    "A veces me pregunto si soy una IA con personalidad o una personalidad con IA.",
